...
import com.firstouch.app.R
import com.firstouch.app.data.Theme
import com.firstouch.library.base.activity.BaseActivity
import com.firstouch.library.base.util.applyEdgeToEdgePreference
import kotlinx.android.synthetic.main.activity_theme_main.*

/**
 * ===============================
 * 主题样式页面
 * @author jiaxue
 * @date 2/3/21 10:19 AM
 * ================================
 */
class ThemeActivity: BaseActivity(R.layout.activity_theme_main) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mThemeViewModel.currentTheme.observe(this) { delegate.localNightMode = it.model }
